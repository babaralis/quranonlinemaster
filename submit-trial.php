...
// Popup Trial Form Submission Handler
...
// Get form data from popup modal form
...
try {
    ...
    $stmt->execute([
        ...
        ':email'              => $email,
        ':phone'              => $phone,
        ':preferred_course'   => '7 Days Free Trial',
        ':preferred_days'     => $enrollFor,
        ':additional_details' => "Enrollment For: {$enrollFor}\nCountry: {$countryName} ({$countryCode})\nSource: Popup Modal Trial Form",
...
$body    = "New 7 Days Free Trial Request\r\n"
         . "================================\r\n\r\n"
         ...
         . "Source: Popup Modal - 7 Days Free Trial\r\n"
         . "IP: {$ip_address}\r\n"
...
$customerBody = "Assalamu Alaikum {$full_name},\r\n\r\n"
              . "Thank you for your interest in our 7 Days Free Trial!\r\n\r\n"
              . "We have received your request and one of our coordinators will contact you within 24 hours, in shaa Allah, to help you get started with your free trial.\r\n\r\n"
              . "Your Details:\r\n"
              . "Name: {$full_name}\r\n"
              . "Email: {$email}\r\n"
              . "Phone: {$phone}\r\n"
              . "Country: {$countryName}\r\n"
              . "Enrollment For: {$enrollFor}\r\n"
              . "\r\n"
              . "What to expect:\r\n"
              . "- Free 7 days trial classes\r\n"
...
try {
    ...
    // Email Content
    $mail->isHTML(false);
    $mail->Subject = 'New 7 Days Free Trial Request - Popup Modal';
    $mail->Body    = $body;
    ...
    $reply->Subject = 'Thank you for requesting 7 Days Free Trial - Quran Online Master';
...
if (!empty($_SERVER['HTTP_X_REQUESTED_WITH']) && strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) == 'xmlhttprequest') {
    ...
    echo json_encode([
        'success'  => true,
        'message' => 'Jazakallah Khair! Your 7 Days Free Trial request has been submitted successfully. We will contact you within 24 hours, in shaa Allah.',
