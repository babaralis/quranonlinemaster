    ...
    <div class="container absolute-center">
        <div class="row position-relative">
            <div class="col-lg-7 col-md-12 col-12 my-auto">
                ...
                <p class="lead mb-4">
                    Let's study how to understand the Holy Quran online. All genders are welcome to learn
                </p>
            </div>
        </div>
    </div>
     ...
     <div class="row justify-content-center">
        <div class="col-lg-8">
           <div class="inner-course-detail">
              <h2 class="title">About Tajweed Course</h2>
              <p class="text-muted mt-3 mb-0">the Quran Memorization is to learn every word of it by heart. Memorizing the Quran is different from memorizing any other piece of text. It is a great responsibility to learn the Quran correctly, as you cannot and must not change any word or even the slightest makharij.</p>
              <p class="text-muted mt-3 mb-0">Changes in makharij often change the entire meaning and context of the word and the verse in its entirety. It is the message of Allah, thus should be learned and held with immense concentration and great responsibility.              </p>
              <p class="text-muted mt-3 mb-0">Being able to learn the Quran by heart is a beautiful feeling, a great asset and sacred possession in itself. It’s like you <a href="#">carry the Quran in your heart</a>. Wherever you go and whatever you do, the light of the Holy Book follows you.</p>
              <blockquote>
                 <p class="text-muted mt-0 mb-0">To master the recitation of the Quran, one needs to excel in “Tajweed”. The literal meaning of “Tajweed” is to improve.</p>
              </blockquote>
              <p class="text-muted mt-3 mb-0">When taught with the Quran, it refers to enhancing our recitation of the Quran.</p>
              <p class="text-muted mt-3 mb-0">Tajweed constitutes the rules and regulations one needs to follow in recitation to make it beautiful and accurate.
              </p>
              <p class="text-muted mt-3 mb-0">Moreover, reciting Quran with proper Tajweed, in accordance with the proper rules and pronunciations, taking care of all the minor details and making sure nothing is missed out or pronounced differently.
              </p>
              <p class="text-muted mt-3 mb-0">Pronouncing Quranic words differently leads to a changed meaning, and it’s a sin to add or subtract from the true meaning of the Quran.
              </p>
              <p class="text-muted mt-3 mb-0">Tajweed is essential to follow and abide by to recite the Holy Quran rightfully and carefully.         </p>
           </div>
        </div>
           ...
           <div class="inner-side-course-area">
              <div class="inner-side-course-detail-head">
                 ...
                 <div class="inner-side-course-detail">
                    ...
                    <p>Quran Memorization Course Outline</p>
                 </div>
              </div>
              <ul>
                 <p class="ayat">﷽</p>
                 <p class="text-center">What will you learn in quran memorization course?</p>
                  <li>Accurate Memorization of The Book of Allah (Quran)</li>
                  <li>Techniques For Fast Memorization</li>
                  <li>The Forgetfulness Types</li>
                  <li>How To Overcome Forgetfulness</li>
                  <li>The General Meaning of The Verses</li>
                  <li>The Reasons For Revealing The Verses</li>
                  <li>Advantages of Memorizing The Quran</li>
                </ul>
                <div class="btn btn-main cource-aboutbtn"> <a href="javascript:void(0)" class="filled-link signup-popup-btn">Get Enrolled Now</a> 
                </div>
           </div>
        </div>
     </div>
...
<section class="section-padding patter-2">
  <div class="container">
    <div class="row align-items-center gy-4">
            ...
            <div class="col-lg-6 col-md-6 col-12 mobile-order2">
              ...
              <h2 class="fw-semibold mb-3 title">Why Taking The Quran Memorization Course?</h2>
              <div class="section-divider m-0 mb-4"></div>
              <p class="text-muted">
               We, at Quran Ayat, offer the Quran Memorization course, where we have assimilated the top Quran scholars and professionals for you. A thorough schedule would be discussed with you at the beginning of the session and our professionals would help you follow it to achieve your goal in the decided time frame. You will be exposed to repeated tests that to make sure the Quran stays with you for a long time and you don’t forget it.
              </p>            
