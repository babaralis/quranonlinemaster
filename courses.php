...
<div class="row align-items-center gy-4">
            ...
            <div class="col-lg-6 col-md-6 col-12 mobile-order2">
              ...
              <h2 class="fw-semibold mb-3 title">Why Go For Quran Master Online?</h2>
              <p class="text-muted">
...
<!-- Courses Tabs Section -->
  <section id="courses" class="section-padding  onlinequran-courses">
    <div class="container">
      ...
      <div class="row gy-4 position-relative">
        <div class="col-lg-7 col-md-6 col-12">
          <div class="bg-white rounded-4 p-4 border">
            <div id="formMessageCourses" class="alert d-none mb-3" role="alert"></div>
            <form id="coursesForm" method="POST" action="submit.php">
              <div class="row g-3">
                <div class="col-md-6">
                  <label class="form-label small" for="fullNameCourses">Full Name <span class="text-danger">*</span></label>
                  <input type="text" id="fullNameCourses" name="fullName" class="form-control" placeholder="Your full name" required />
                ...
                <div class="col-md-6">
                  <label class="form-label small" for="prefDaysCourses">Preferred Days</label>
                  <input type="text" id="prefDaysCourses" name="prefDays" class="form-control" placeholder="e.g. Mon, Wed, Fri" />
                </div>
                <div class="col-12">
                  <label class="form-label small" for="extraDetailsCourses">Any additional details</label>
                  <textarea
                    id="extraDetailsCourses"
                    name="extraDetails"
                    class="form-control"
                    rows="3"
          ...
          document.addEventListener('DOMContentLoaded', function() {
              ...
              const formMessage = document.getElementById('formMessageCourses');
                      ...
                      if (data.success) {
                          ...
                          if (data.errors) {
                              for (let field in data.errors) {
                                  const input = document.getElementById(field + 'Courses');
                                  if (input) {
              ...
              coursesForm.querySelectorAll('input, select, textarea').forEach(field => {
